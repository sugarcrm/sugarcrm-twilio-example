		...
		try {
			...
			Twilio.Device.error(function (error) {
				...
				Client.error(error);
                        ...
                        /*
                         * comment out following code since it's defined in twilio_client.tpl 
                         * begin xye@sugarcrm.com
                         */
...
//                                alert('another entrypoint in client.js');
//				Client.incoming(conn);
//			});

                        /*
                         * comment out following code since it's defined in twilio_client.tpl 
                         * end xye@sugarcrm.com
                         */
